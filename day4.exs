...
overlapping_assignments = Enum.filter(assignments, fn [start1, end1, start2, end2] -> (start1<=start2 and end1>=start2) or (start2<=start1 and end2>=start1) end)
IO.puts(length(overlapping_assignments))
